function(b) {
    ...
    b(function() {
        ...
        a = b(".navigation--sidebar"),
        t = b(".ps-cart--sidebar"),
        s = b(".ps-filter--sidebar"),
        b(".header  .menu-toggle").on("click", function(e) {
            e.preventDefault(),
            a.addClass("active"),
            b(".ps-site-overlay").addClass("active")
        }),
        ...
        b(".navigation--sidebar .navigation__header .ps-btn--close").on("click", function(e) {
            ...
            b(".ps-site-overlay").removeClass("active")
        }),
        ...
        b("body").on("click", function(e) {
            b(e.target).siblings(".navigation--sidebar").hasClass("active") && (a.removeClass("active"),
            b(".ps-site-overlay").removeClass("active")),
            b(e.target).siblings(".ps-cart--sidebar").hasClass("active") && (t.removeClass("active"),
            b(".ps-site-overlay").removeClass("active")),
            b(e.target).siblings(".ps-filter--sidebar").hasClass("active") && (s.removeClass("active"),
            b(".ps-site-overlay").removeClass("active"))
        }),
        b(".menu--mobile .menu-item-has-children > .sub-toggle").on("click", function(e) {
            ...
            a.siblings().find(".sub-toggle").removeClass("active"),
            a.children(".sub-menu").slideToggle(350),
            a.siblings().find(".sub-menu").slideUp(350),
            a.hasClass("has-mega-menu") && (a.children(".mega-menu").slideToggle(350),
            a.siblings(".has-mega-menu").find(".mega-menu").slideUp(350))
        }),
        b(".menu--mobile .has-mega-menu .mega-menu__column .sub-toggle").on("click", function(e) {
            ...
            b(this).toggleClass("active"),
            a.siblings().find(".sub-toggle").removeClass("active"),
            a.children(".mega-menu__list").slideToggle(350),
            a.siblings().find(".mega-menu__list").slideUp(350)
        }),
        function(e) {
            var a = b(e);
            if (0 < a.length)
                if (a.hasClass("filter")) {
                    ...
                    t.on("click", function(e) {
                        ...
                        return t.find("a").removeClass("current"),
                        b(this).parent("li").addClass("current"),
                        b(this).parent("li").siblings("li").removeClass("current"),
                        b(this).closest(".masonry-root").find(".ps-masonry").isotope({
                            itemSelector: ".grid-item",
                            isotope: {
                                columnWidth: ".grid-sizer"
                            },
        ...
        b(".ps-filter__trigger").on("click", function(e) {
            e.preventDefault();
            var a = b(this);
            a.find(".ps-filter__icon").toggleClass("active"),
            a.closest(".ps-filter").find(".ps-filter__content").slideToggle()
        }),
        0 < b(".ps-sidebar--home").length && b(".ps-sidebar--home > .ps-sidebar__header > a").on("click", function(e) {
            e.preventDefault(),
            b(this).closest(".ps-sidebar--home").children(".ps-sidebar__content").slideToggle()
        }),
        b(".ps-tab-list > li > a ").on("click", function(e) {
            e.preventDefault();
            var a = b(this).attr("href");
            b(this).closest("li").siblings("li").removeClass("active"),
            b(this).closest("li").addClass("active"),
            b(a).addClass("active"),
            b(a).siblings(".ps-tab").removeClass("active")
        }),
        function() {
        ...
        b(window).scroll(function() {
            ...
            i < e && 500 < e ? o.addClass("active") : o.removeClass("active"),
            i = e
        }),
        o.on("click", function() {
            b("html, body").animate({
        ...
        (n = b(".ps-modal")).length && n.hasClass("active") && b("body").css("overflow-y", "hidden"),
        n.find(".ps-modal__close, .ps-btn--close").on("click", function(e) {
            e.preventDefault(),
            b(this).closest(".ps-modal").removeClass("active")
        }),
        ...
        b(".ps-modal").on("click", function(e) {
            b(e.target).closest(".ps-modal__container").length || (n.removeClass("active"),
            b("body").css("overflow-y", "auto"))
        }),
        l = b(".ps-search"),
        b(".ps-search-btn").on("click", function(e) {
            e.preventDefault(),
            l.addClass("active")
        }),
        ...
        b(".ps-countdown").each(function() {
            var n = b(this)
              ...
              , r = setInterval(function() {
                ...
                n.find(".days").html(t),
                n.find(".hours").html(s),
                n.find(".minutes").html(i),
                n.find(".seconds").html(o),
                a < 0 && (clearInterval(r),
                n.closest(".ps-section").hide())
            }, 1e3)
        }),
        ...
        function() {
            ...
            0 < b(".sticky-2").length)
                var s = new StickySidebar(".ps-product__sticky .sticky-2",{
                    topSpacing: 20,
                    bottomSpacing: 20,
                    containerSelector: ".ps-product__sticky"
                });
        ...
        (r = b(".ps-accordion")).find(".ps-accordion__content").hide(),
        b(".ps-accordion.active").find(".ps-accordion__content").show(),
        r.find(".ps-accordion__header").on("click", function(e) {
            e.preventDefault(),
            b(this).closest(".ps-accordion").hasClass("active") ? (b(this).closest(".ps-accordion").removeClass("active"),
            b(this).closest(".ps-accordion").find(".ps-accordion__content").slideUp(350)) : (b(this).closest(".ps-accordion").addClass("active"),
            b(this).closest(".ps-accordion").find(".ps-accordion__content").slideDown(350),
            b(this).closest(".ps-accordion").siblings(".ps-accordion").find(".ps-accordion__content").slideUp()),
            b(this).closest(".ps-accordion").siblings(".ps-accordion").removeClass("active"),
            b(this).closest(".ps-accordion").siblings(".ps-accordion").find(".ps-accordion__content").slideUp()
        })
    }),
    b(window).on("load", function() {
        var a, e;
        b("body").addClass("loaded"),
        a = b("#subscribe"),
        e = a.data("time"),
        setTimeout(function() {
            0 < a.length && (a.addClass("active"),
            b("body").css("overflow", "hidden"))
        }, e),
        b(".ps-popup__close").on("click", function(e) {
            e.preventDefault(),
            b(this).closest(".ps-popup").removeClass("active"),
            b("body").css("overflow", "auto")
        }),
        b("#subscribe").on("click", function(e) {
            b(e.target).closest(".ps-popup__content").length || (a.removeClass("active"),
            b("body").css("overflow-y", "auto"))
        })
    })
}(jQuery);
